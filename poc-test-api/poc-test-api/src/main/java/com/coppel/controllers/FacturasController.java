...
public class FacturasController {
    ...
    public ApiResponseDTO registrarFacturas(@Valid @RequestBody FacturasDTO nuevaFactura) {
    ...
    public ApiResponseDTO actualizarFactura(@PathVariable Long id, @Valid @RequestBody FacturasDTO facturaActualizada) {
